...
import static com.newsproject.fisher.domain.LikesAsserts.*;
...
class LikesResourceIT {
    ...
    void putExistingLikes() throws Exception {
        ...
        updatedLikes.articleId(UPDATED_ARTICLE_ID).userId(UPDATED_USER_ID).commentId(UPDATED_COMMENT_ID).likeCount(UPDATED_LIKE_COUNT);
    ...
    void partialUpdateLikesWithPatch() throws Exception {
        ...
        partialUpdatedLikes.articleId(UPDATED_ARTICLE_ID);
