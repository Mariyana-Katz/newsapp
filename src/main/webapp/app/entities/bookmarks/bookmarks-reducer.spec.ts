...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bookmarks.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOOKMARKS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOOKMARKS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOOKMARKS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BOOKMARKS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BOOKMARKS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOOKMARKS actions', async () => {
      const arg = 42666;
