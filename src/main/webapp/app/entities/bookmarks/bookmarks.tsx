          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  Bookmarked By <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {bookmarksList.map((bookmarks, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{bookmarks.articleId}</td>
                  <td>{bookmarks.userId}</td>
                  <td>{bookmarks.bookmarkedBy ? bookmarks.bookmarkedBy.id : ''}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`/bookmarks/${bookmarks.id}`} color="info" size="sm" data-cy="entityDetailsButton">
                        <FontAwesomeIcon icon="eye" /> <span className="d-none d-md-inline">View</span>
                      </Button>
                      <Button tag={Link} to={`/bookmarks/${bookmarks.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
                        <FontAwesomeIcon icon="pencil-alt" /> <span className="d-none d-md-inline">Edit</span>
                      </Button>
                      <Button
                        onClick={() => (window.location.href = `/bookmarks/${bookmarks.id}/delete`)}
                        color="danger"
                        size="sm"
