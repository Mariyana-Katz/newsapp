...
export const BookmarksDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="newsprojectApp.bookmarks.delete.question">Are you sure you want to delete Bookmarks {bookmarksEntity.id}?</ModalBody>
      <ModalFooter>
