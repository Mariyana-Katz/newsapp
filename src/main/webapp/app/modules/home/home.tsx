    ...
    <Row>
      ...
      <div className="headline-story">
        ...
        <p className="headline-story-text">
          U.S. Secretary of State Antony Blinken has met with Israeli leaders in his push for a cease-fire deal between Israel and Hamas to
          impress on them that “the time is now\" for an agreement that would free hostages and bring a pause in the nearly seven months of
          …
        </p>
      </div>
    </Row>
